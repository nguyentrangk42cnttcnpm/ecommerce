...
$sql = "INSERT INTO `products` VALUES (id='$id',nam='$name',price='$price',view='$view',discount='$discount'
                    ,brands_id='$brand_id',category_id='$category_id')";
...
<div class="container-scroller">
    ...
    <h1 class="card-title">Thêm products</h1>   
